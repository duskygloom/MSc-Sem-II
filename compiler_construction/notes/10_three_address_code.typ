...
- The three address statement, $ x = y "op" z $ is represented by replacing $y$ in $"arg"_1$, $z$ in $"arg"_2$ and $x$ in result.
...
$ a * -(b + c) $
into a syntax tree, three-address code and quadruple.
#v(1em)

=== Syntax tree
#image("assets/problem_syntax_tree.png", height: 15em),
...
#table(
  columns: (6em,) * 4,
  align: (center,) * 4,
  table.header([$"op"$], [$"arg"_1$], [$"arg"_2$], [$"result"$]),
  [$+$], [$b$], [$c$], [$t_1$],
  [$"minus"$], [$t_1$], [], [$t_2$],
  [$times$], [$a$], [$t_2$], [$t_3$],
)
